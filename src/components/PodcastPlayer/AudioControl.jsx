...
export default function AudioControl({
    ...
    return (
        <div
            className={`${isMobile ? "pb-10" : "pb-0"} z-40 flex rounded-t-2xl flex-col items-center gap-0 px-5 transition-all duration-200 ease-in-out md:max-h-[165px] ${isExpand && isCommentVisible ? "w-1/2 lg:pl-10 bg-neutral-900 lg:pb-6" : "w-full lg:p-4 lg:px-10 bg-[#171717]/20 backdrop-blur-2xl lg:pb-0"}`}
        >
            <div
            ...
            <div
                className={`mb-5 flex w-full flex-col pb-2 ${isExpand && isCommentVisible ? "-mt-2 pb-6" : "mt-2"}`}
            >
