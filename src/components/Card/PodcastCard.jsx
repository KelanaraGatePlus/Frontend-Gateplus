...
export default function PodcastCard({
  ...
  const href = customHref || `/${contentType.podcasts.pluralName}/detail/${id}`;

  return (
    <Link href={href} className="block h-full w-full">
      <div className="group relative flex h-full w-full flex-col overflow-hidden rounded-[6px] bg-transparent">
        <div className="relative w-full" style={{ paddingBottom: "140%" }}>
          <div className="absolute inset-0 overflow-hidden rounded-t-[6px]">
            {/* Banner Atas */}
            <div className="absolute inset-x-0 top-0 z-20 flex items-start justify-start px-2 py-1">
