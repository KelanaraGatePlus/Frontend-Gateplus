  ...
  return (
    <div ref={profileRef} className="relative md:mt-0.5 md:block md:py-3">
      ...
      <AnimatePresence initial={false}>
        {isProfileMenuOpen && (
          <motion.div
            className="montserratFont custom-scrollbar absolute top-11 right-0 flex max-h-[85vh] w-80 flex-col gap-3 overflow-y-auto rounded-lg bg-[#0395BC] px-3 py-4 lg:top-16"
