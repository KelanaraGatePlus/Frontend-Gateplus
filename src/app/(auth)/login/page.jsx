...
import { useRouter } from "next/navigation"; // buat redirect
import logo from "@@/logo/logoGate+/logo-header-login.svg";
import FormLogin from "@/components/Form/AuthForm/FormLogin/page";
import { useAuth } from "@/components/Context/AuthContext"; // buat refresh
...
export default function LoginPage() {
  ...
  // nambah fungsi ketika login berhasil
  const handleLoginSuccess = async (data) => {
    try {
      ...
      console.warn("refreshUser gagal:", err);
      setIsError(true);
      setErrorMessage("Gagal memuat data user terbaru.");
    }
  };
