...
export default function ReadComic({ params }) {
  const { id } = use(params);
  ...
  const getData = async () => {
    try {
      const comicSingleData = {
        id: "cmbt79vbw0001jwvs0vopicsum1",
        comicsId: "cmbpicsum0001jwvw9ledao1x",
        creatorId: "4d88a00f-23da-4856-8f01-c6aefb882d76",
        title: "Petualangan Si Gambar Random",
        description: "Komik absurd dari dunia acak penuh kejutan.",
        price: "15000",
        views: 42,
        coverImageUrl: "https://picsum.photos/seed/coverrandom/800/1200",
        fileImageComics: [
        ...
        notedEpisode: "Jangan percaya apa pun yang kamu lihat di sini.",
        createdAt: "2025-06-18T10:00:00.000Z",
        updatedAt: "2025-06-18T10:00:00.000Z",
        comics: {
          id: "cmbpicsum0001jwvw9ledao1x",
          title: "Koleksi Komik Picsum",
        },
      };
