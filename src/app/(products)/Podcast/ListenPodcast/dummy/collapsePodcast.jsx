...
export default function CollapsePodcast({
  ...
  return (
    <div className="flex h-[72%] w-full">
      <div
        className={`custom-scrollbar relative mt-8 flex flex-col bg-transparent transition-all duration-200 ease-in-out ${isCommentVisible ? "w-1/2 gap-8 overflow-x-hidden lg:pr-5 lg:pl-10" : "w-full gap-5 overflow-x-hidden px-4 sm:px-6 lg:px-12"}`}
      >
        <section
              ...
              <div key={index} className="flex gap-4">
                ...
                <div className="flex flex-1 justify-between gap-4">
                  ...
                  <div className="w-1.8/5 flex items-center justify-center gap-2 sm:w-1/5">
                    ...
                    <button className="relative z-20 h-6 w-6 cursor-pointer transition-transform duration-150 active:scale-90">
                      <Image
                        priority
                        src={iconMore}
                        alt="icon-more"
        ...
        <div className="h-10 w-full bg-transparent text-transparent">
          gateplus
        </div>
      </div>
