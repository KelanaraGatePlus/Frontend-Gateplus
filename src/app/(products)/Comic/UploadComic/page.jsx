              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex w-full flex-4 text-white md:flex-10">
                  <input
                    type="text"
                    name="title"
                    className="w-full scroll-mt-32 rounded-md border border-[#F5F5F540] bg-[#2222224D] px-2 py-1"
                ...
                <div className="flex h-full w-fit flex-4 flex-wrap items-stretch justify-start gap-x-6 text-white md:flex-10">
                  <div className="container flex w-full flex-wrap items-start gap-4 rounded-md bg-[#585454] p-2">
                    ...
                    <div className="flex flex-col items-center">
                      <div className="relative h-24 w-24 cursor-pointer overflow-hidden rounded-md bg-gray-500 md:h-28 md:w-42">
                        <input
                          type="file"
                        ...
                        >
                          <div className="relative h-24 w-full md:h-28">
                            ...
                            <button
                              ...
                              className="absolute top-1 right-1 flex h-5 w-5 cursor-pointer items-center justify-center rounded-full bg-red-600 text-xs text-white"
                            >
              ...
              <section className="flex items-start gap-2 text-[#979797]">
                ...
                <div className="flex h-full w-fit flex-4 flex-wrap items-stretch justify-start gap-x-6 text-white md:flex-10">
                  <div className="container flex w-full flex-wrap items-start gap-4 rounded-md bg-[#585454] p-2">
                    {/* Upload Section */}
                    <div className="flex flex-col items-center">
                      <div className="relative h-24 w-24 cursor-pointer overflow-hidden rounded-md bg-gray-500 md:h-40 md:w-32">
                        <input
                          type="file"
                          accept="image/png, image/jpeg"
                    ...
                    <div className="flex flex-wrap gap-4">
                      {uploadedFiles.coverBook?.map((file, index) => (
                        <div
                          key={index}
                          className="relative flex h-28 w-24 flex-col items-center overflow-hidden rounded-md bg-gray-500 md:h-[180px] md:w-32"
                        >
